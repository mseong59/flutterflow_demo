...
import 'schema/user_daily_history_record.dart';
...
export 'schema/user_daily_history_record.dart';
...
/// Functions to query UserDailyHistoryRecords (as a Stream and as a Future).
Future<int> queryUserDailyHistoryRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UserDailyHistoryRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserDailyHistoryRecord>> queryUserDailyHistoryRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UserDailyHistoryRecord.collection,
      UserDailyHistoryRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserDailyHistoryRecord>> queryUserDailyHistoryRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
